...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ CHANNEL ⭕️", url="https://t.me/Cinema_Crave_Official")], [InlineKeyboardButton(text="😇 SUPPORT", url="https://t.me/TroJanzSupport"),
