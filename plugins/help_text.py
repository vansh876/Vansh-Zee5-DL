...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ JOIN OUR CHANNEL ⭕️", url="https://t.me/Cinema_Crave_Official")]]),
        parse_mode="html",
...
def send_start(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="⭕️ CHANNEL ⭕️", url="https://t.me/Cinema_Crave_Official")], [InlineKeyboardButton(text="😇 SUPPORT", url="https://t.me/Cinema_Crave_Official"),
